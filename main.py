...
root.title("Nicholas' Calculator")
...
def button_click(number):
    ...
    e.delete(0, END)
    # Insert the new value into the calculator display
...
def button_add():
    first_number = e.get()
    # Store the first number in a global variable
    global f_num
    global math
    math = "addition"
...
button_square = Button(root, text="^", padx=41, pady=20, command= button_square)
